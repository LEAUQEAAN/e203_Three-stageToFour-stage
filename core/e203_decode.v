...
module e203_decode(
  ...
  assign rf_rs1 = flag_rf_rs1 ? rf_wbck_wdat : rf_rs1_nxt ; 

  wire flag_rf_rs2 = (dec_rs2idx == rf_wbck_rdidx ) & rf_wbck_ena ;
  assign rf_rs2 = flag_rf_rs2 ?  rf_wbck_wdat : rf_rs2_nxt ;

  wire flag_1idx_ifu1 = (i_rs1idx == rf_wbck_rdidx ) & rf_wbck_ena ;
  wire flag_1idx_ifu = (i_rs1idx == rf_wbck_o_rdidx_pre ) & rf_wbck_o_ena_pre ; 
  assign rf2ifu_rs1 = flag_1idx_ifu ? rf_wbck_o_wdat_pre : (flag_1idx_ifu1 ? rf_wbck_wdat : rf2ifu_rs1_nxt ) ;   
